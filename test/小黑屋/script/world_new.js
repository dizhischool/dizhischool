var World = {
	...
	VILLAGE_POS: [30, 30],
	TILE: {
		VILLAGE: '<img class="forest_img" src="./img/village.png" />', //村庄
		IRON_MINE: '<img class="forest_img" src="./img/iron_mine.png" />', //铁矿
		COAL_MINE: '<img class="forest_img" src="./img/coal_mine.png" />', //煤矿
		SULPHUR_MINE: '<img class="forest_img" src="./img/sulphur_mine.png" />', //硫磺矿
		FOREST: '<img class="forest_img" src="./img/1.png" />', //森林
		FIELD: '<img class="forest_img" src="./img/2.png" />', //草地
		BARRENS: '<img class="forest_img" src="./img/3.png" />', //荒地
		ROAD: '<img class="forest_img" src="./img/1.png" />', //道路
		HOUSE: '<img class="forest_img" src="./img/house.png" />', //废弃小屋
		CAVE: '<img class="forest_img" src="./img/cave.png" />', //洞穴
		TOWN: '<img class="forest_img" src="./img/town.png" />', //城镇
		CITY: '<img class="forest_img" src="./img/city.png" />', //城市
		OUTPOST: '<img class="forest_img" src="./img/outpost.png" />', //前哨
		SHIP: '<img class="forest_img" src="./img/ship.png" />', //飞船
		BOREHOLE: '<img class="forest_img" src="./img/borehole.png" />', //巨坑
		BATTLEFIELD: '<img class="forest_img" src="./img/battlefield.png" />', //战场
		SWAMP: '<img class="forest_img" src="./img/swamp.png" />', //沼泽地
    CACHE: 'U'
	},
	TILE_PROBS: {},
	LANDMARKS: {},
	...
	chooseTile: function(x, y, map) {
		...
		for(var i in list) {
			...
			//if(r < c) {
				//console.log(prob.charAt(prob.length - 1));
		...
		for(var j = 0; j <= World.RADIUS * 2; j++) {
			for(var i = 0; i <= World.RADIUS * 2; i++) {
				...
				if(World.curPos[0] == i && World.curPos[1] == j) {
					...
					mapString += '<span class="landmark"><img class="forest_img" src="./img/@.png" /><div class="tooltip ' + ttClass + '">'+_('Wanderer')+'</div></span>';
					...
					mapString += '<img class="forest_img" src="./img/bg.png" />';
				}
			}
			mapString += '<br/>';
		}
	...
	die: function() {
		if(!World.dead) {
		    document.getElementById('bagspace-world').style.position = "absolute";
			World.dead = true;
	...
	onArrival: function() {
		...
		document.getElementById('bagspace-world').style.position = "fixed";
	},
